...
import { useBaseTrading } from '../../shared/hooks/use-base-trading';
import type { UseBaseTradingParams } from '../../shared/hooks/use-base-trading';
import type { Direction, DurationSelectUnit, DurationOption, OpenPosition, ClosedPosition } from '../lib/types';
import { getDurationOptions, computeEndTimeEpoch } from '../../shared/lib/duration-utils';
